...
import com.feng.yupicturebackend.common.DeleteRequest;
...
import com.feng.yupicturebackend.model.enums.CodeEnum;
...
public class UserController {
    ...
    @GetMapping("/codeEnum")
    public BaseResponse<CodeEnum.TypeObject> getLoginUserByCode() {
        log.info("get login user by code");
        return null;
    }
    ...
    public BaseResponse<Boolean> userLogout(HttpServletRequest request) {
        ...
        Boolean result = userService.getLogout(request);
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest) {
        ...
        String encryptPassword = userService.getEntryPassword(DEFAULT_PASSWORD);
